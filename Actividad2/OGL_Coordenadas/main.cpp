...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("coordenadas.vs", "coordenadas.fs");
    ...
    float vertices[] = {
        ...
        //white
         /*-0.5f, -0.5f, -0.5f,  0.75f, 0.66f,
         0.5f, -0.5f, -0.5f,  0.5f, 0.66f,
         0.5f,  0.5f, -0.5f,  0.5f, 0.34f,
         0.5f,  0.5f, -0.5f,  0.5f, 0.34f,
        -0.5f,  0.5f, -0.5f,  0.75f, 0.34f,
        -0.5f, -0.5f, -0.5f,  0.75f, 0.66f,*/
    ...
    unsigned char* data = stbi_load("C:\\gl\\resources\\textures\\rubik\\rubik.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
